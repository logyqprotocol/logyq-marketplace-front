...
import { formatBalance, getValueForSend } from "../utils/functions";
...
function BiddingContainer(props: {
  ...
  const makeOffer = async (_amount: number) => {
    ...
    try {
      if (
        ...
        return;
      const contract = new props.userProvider!.Contract(
        Abi,
        new Address(CONTRACT_ADDR)
      );
      const result = await contract.methods
        .makeOffer({
          _amount: getValueForSend(_amount),
